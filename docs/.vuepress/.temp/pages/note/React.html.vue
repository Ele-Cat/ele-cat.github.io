<template><h1 id="react全家桶-技术栈" tabindex="-1"><a class="header-anchor" href="#react全家桶-技术栈" aria-hidden="true">#</a> React全家桶（技术栈）</h1>
<ul>
<li><a href="https://www.gulixueyuan.com/goods/show/517" target="_blank" rel="noopener noreferrer">学习地址<ExternalLinkIcon/></a></li>
<li><a href="https://gitee.com/ele-cat/react-basic" target="_blank" rel="noopener noreferrer">示例地址<ExternalLinkIcon/></a></li>
</ul>
<h2 id="_1-react入门" tabindex="-1"><a class="header-anchor" href="#_1-react入门" aria-hidden="true">#</a> 1.React入门</h2>
<h3 id="_1-1-react简介" tabindex="-1"><a class="header-anchor" href="#_1-1-react简介" aria-hidden="true">#</a> 1.1 React简介</h3>
<h4 id="_1-1-1-官网" tabindex="-1"><a class="header-anchor" href="#_1-1-1-官网" aria-hidden="true">#</a> 1.1.1 官网</h4>
<ul>
<li><a href="https://reactjs.org/" target="_blank" rel="noopener noreferrer">英文官网<ExternalLinkIcon/></a></li>
<li><a href="https://react.docschina.org/" target="_blank" rel="noopener noreferrer">中文官网<ExternalLinkIcon/></a></li>
</ul>
<h4 id="_1-1-2-介绍描述" tabindex="-1"><a class="header-anchor" href="#_1-1-2-介绍描述" aria-hidden="true">#</a> 1.1.2 介绍描述</h4>
<ol>
<li>用于动态构建用户界面的 JavaScript 库(只关注于视图)</li>
<li>由Facebook开源</li>
</ol>
<h4 id="_1-1-3-react的特点" tabindex="-1"><a class="header-anchor" href="#_1-1-3-react的特点" aria-hidden="true">#</a> 1.1.3 React的特点</h4>
<ol>
<li>声明式编码</li>
<li>组件化编码</li>
<li>React Native 编写原生应用</li>
<li>高效（优秀的Diffing算法）</li>
</ol>
<h4 id="_1-1-4-react高效的原因" tabindex="-1"><a class="header-anchor" href="#_1-1-4-react高效的原因" aria-hidden="true">#</a> 1.1.4 React高效的原因</h4>
<ol>
<li>使用虚拟(virtual)DOM, 不总是直接操作页面真实DOM。</li>
<li>DOM Diffing算法, 最小化页面重绘。</li>
</ol>
<h3 id="_1-2-react的基本使用" tabindex="-1"><a class="header-anchor" href="#_1-2-react的基本使用" aria-hidden="true">#</a> 1.2 React的基本使用</h3>
<h4 id="_1-2-1-效果" tabindex="-1"><a class="header-anchor" href="#_1-2-1-效果" aria-hidden="true">#</a> 1.2.1 效果</h4>
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br></div></div><h4 id="_1-2-2-相关js库" tabindex="-1"><a class="header-anchor" href="#_1-2-2-相关js库" aria-hidden="true">#</a> 1.2.2 相关js库</h4>
<ol>
<li>react.js：React核心库。</li>
<li>react-dom.js：提供操作DOM的react扩展库。</li>
<li>babel.min.js：解析JSX语法代码转为JS代码的库。</li>
</ol>
<h4 id="_1-2-3-创建虚拟dom的两种方式" tabindex="-1"><a class="header-anchor" href="#_1-2-3-创建虚拟dom的两种方式" aria-hidden="true">#</a> 1.2.3 创建虚拟DOM的两种方式</h4>
<ol>
<li>纯JS方式(一般不用)</li>
<li>JSX方式</li>
</ol>
<h4 id="_1-2-4-虚拟dom与真实dom" tabindex="-1"><a class="header-anchor" href="#_1-2-4-虚拟dom与真实dom" aria-hidden="true">#</a> 1.2.4 虚拟DOM与真实DOM</h4>
<ol>
<li>React提供了一些API来创建一种 “特别” 的一般js对象
<ul>
<li>const VDOM = React.createElement('xx',{id:'xx'},'xx')</li>
...
<h3 id="_1-3-react-jsx" tabindex="-1"><a class="header-anchor" href="#_1-3-react-jsx" aria-hidden="true">#</a> 1.3 React JSX</h3>
<h4 id="_1-3-1-效果" tabindex="-1"><a class="header-anchor" href="#_1-3-1-效果" aria-hidden="true">#</a> 1.3.1 效果</h4>
<div class="language-html ext-html line-numbers-mode"><pre v-pre class="language-html"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span><span class="token punctuation">></span></span>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br></div></div><h4 id="_1-3-2-jsx" tabindex="-1"><a class="header-anchor" href="#_1-3-2-jsx" aria-hidden="true">#</a> 1.3.2 JSX</h4>
<ol>
<li>全称:  JavaScript XML</li>
<li>react定义的一种类似于XML的JS扩展语法: JS + XML本质是React.createElement(component, props, ...children)方法的语法糖</li>
<li>作用: 用来简化创建虚拟DOM
<ul>
...
<li>标签名任意: HTML标签或其它标签</li>
<li>标签属性任意: HTML标签属性或其它</li>
<li>基本语法规则
<ul>
<li>遇到 &lt;开头的代码, 以标签的语法解析: html同名标签转换为html同名元素, 其它标签需要特别解析</li>
<li>遇到以 { 开头的代码，以JS语法解析: 标签中的js表达式必须用{ }包含</li>
</ul>
</li>
<li>babel.js的作用
<ul>
...
<h4 id="_1-3-3-渲染虚拟dom-元素" tabindex="-1"><a class="header-anchor" href="#_1-3-3-渲染虚拟dom-元素" aria-hidden="true">#</a> 1.3.3 渲染虚拟DOM(元素)</h4>
<ol>
<li>语法:  ReactDOM.render(virtualDOM, containerDOM)</li>
...
<h4 id="_1-3-4-jsx练习" tabindex="-1"><a class="header-anchor" href="#_1-3-4-jsx练习" aria-hidden="true">#</a> 1.3.4 JSX练习</h4>
<ul>
<li>需求: 动态展示列表</li>
</ul>
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br></div></div><h3 id="_1-4-模块与组件、模块化与组件化的理解" tabindex="-1"><a class="header-anchor" href="#_1-4-模块与组件、模块化与组件化的理解" aria-hidden="true">#</a> 1.4 模块与组件、模块化与组件化的理解</h3>
<h4 id="_1-4-1-模块" tabindex="-1"><a class="header-anchor" href="#_1-4-1-模块" aria-hidden="true">#</a> 1.4.1 模块</h4>
<ol>
<li>理解：向外提供特定功能的js程序, 一般就是一个js文件</li>
<li>为什么要拆成模块：随着业务逻辑增加，代码越来越多且复杂。</li>
<li>作用：复用js, 简化js的编写, 提高js运行效率</li>
</ol>
<h4 id="_1-4-2-组件" tabindex="-1"><a class="header-anchor" href="#_1-4-2-组件" aria-hidden="true">#</a> 1.4.2 组件</h4>
<ol>
<li>理解：用来实现局部功能效果的代码和资源的集合(html/css/js/image等等)</li>
<li>为什么要用组件： 一个界面的功能更复杂</li>
<li>作用：复用编码, 简化项目编码, 提高运行效率</li>
</ol>
<h4 id="_1-4-3-模块化" tabindex="-1"><a class="header-anchor" href="#_1-4-3-模块化" aria-hidden="true">#</a> 1.4.3 模块化</h4>
<ul>
<li>当应用的js都以模块来编写的, 这个应用就是一个模块化的应用</li>
</ul>
<h4 id="_1-4-4-组件化" tabindex="-1"><a class="header-anchor" href="#_1-4-4-组件化" aria-hidden="true">#</a> 1.4.4 组件化</h4>
<ul>
<li>当应用是以多组件的方式实现, 这个应用就是一个组件化的应用</li>
</ul>
<h2 id="_2-基本理解和使用" tabindex="-1"><a class="header-anchor" href="#_2-基本理解和使用" aria-hidden="true">#</a> 2.基本理解和使用</h2>
<h3 id="_2-1-基本理解和使用" tabindex="-1"><a class="header-anchor" href="#_2-1-基本理解和使用" aria-hidden="true">#</a> 2.1 基本理解和使用</h3>
<h4 id="_2-1-1-使用react开发者工具调试" tabindex="-1"><a class="header-anchor" href="#_2-1-1-使用react开发者工具调试" aria-hidden="true">#</a> 2.1.1 使用React开发者工具调试</h4>
<ul>
<li>在浏览器中导入<code>react_dev_tools</code>插件</li>
</ul>
<h4 id="_2-1-2-效果" tabindex="-1"><a class="header-anchor" href="#_2-1-2-效果" aria-hidden="true">#</a> 2.1.2 效果</h4>
<p>函数式组件：</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token comment">// 1.创建函数式组件</span>
...
*/</span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br></div></div><p>类式组件：</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token comment">// 1.创建类式组件</span>
...
*/</span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br></div></div><h4 id="_2-1-3-注意" tabindex="-1"><a class="header-anchor" href="#_2-1-3-注意" aria-hidden="true">#</a> 2.1.3 注意</h4>
<ol>
<li>组件名必须首字母大写</li>
<li>虚拟DOM元素只能有一个根元素</li>
<li>虚拟DOM元素必须有结束标签</li>
</ol>
<h4 id="_2-1-4-渲染类组件标签的基本流程" tabindex="-1"><a class="header-anchor" href="#_2-1-4-渲染类组件标签的基本流程" aria-hidden="true">#</a> 2.1.4 渲染类组件标签的基本流程</h4>
<ol>
<li>React内部会创建组件实例对象</li>
<li>调用render()得到虚拟DOM, 并解析为真实DOM</li>
<li>插入到指定的页面元素内部</li>
</ol>
<h3 id="_2-2-属性1-state" tabindex="-1"><a class="header-anchor" href="#_2-2-属性1-state" aria-hidden="true">#</a> 2.2 属性1: state</h3>
<h4 id="_2-2-1-效果" tabindex="-1"><a class="header-anchor" href="#_2-2-1-效果" aria-hidden="true">#</a> 2.2.1 效果</h4>
<p>需求: 定义一个展示天气信息的组件</p>
<ol>
<li>默认展示天气炎热 或 凉爽</li>
<li>点击文字切换天气</li>
</ol>
<h4 id="_2-2-2-理解" tabindex="-1"><a class="header-anchor" href="#_2-2-2-理解" aria-hidden="true">#</a> 2.2.2 理解</h4>
<ol>
<li>state是组件对象最重要的属性, 值是对象(可以包含多个key-value的组合)</li>
<li>组件被称为&quot;状态机&quot;, 通过更新组件的state来更新对应的页面显示(重新渲染组件)</li>
</ol>
<h4 id="_2-2-3-强烈注意" tabindex="-1"><a class="header-anchor" href="#_2-2-3-强烈注意" aria-hidden="true">#</a> 2.2.3 强烈注意</h4>
<ol>
...
<li>状态数据，不能直接修改或更新，需要使用setState函数</li>
<li>state的简写方式：</li>
</ol>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token comment">// 1.创建类式组件</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br></div></div><h3 id="_2-3-属性2-props" tabindex="-1"><a class="header-anchor" href="#_2-3-属性2-props" aria-hidden="true">#</a> 2.3 属性2: props</h3>
<h4 id="_2-3-1-效果" tabindex="-1"><a class="header-anchor" href="#_2-3-1-效果" aria-hidden="true">#</a> 2.3.1 效果</h4>
<p>需求: 自定义用来显示一个人员信息的组件</p>
<ol>
<li>姓名必须指定，且为字符串类型；</li>
<li>性别为字符串类型，如果性别没有指定，默认为男</li>
<li>年龄为字符串类型，且为数字类型，默认值为18</li>
</ol>
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br></div></div><h4 id="_2-3-2-理解" tabindex="-1"><a class="header-anchor" href="#_2-3-2-理解" aria-hidden="true">#</a> 2.3.2 理解</h4>
<ol>
<li>每个组件对象都会有props(properties的简写)属性</li>
<li>组件标签的所有属性都保存在props中</li>
</ol>
<h4 id="_2-3-3-作用" tabindex="-1"><a class="header-anchor" href="#_2-3-3-作用" aria-hidden="true">#</a> 2.3.3 作用</h4>
<ol>
<li>通过标签属性从组件外向组件内传递变化的数据</li>
<li>注意: 组件内部不要修改props数据</li>
</ol>
<h4 id="_2-3-4-编码操作" tabindex="-1"><a class="header-anchor" href="#_2-3-4-编码操作" aria-hidden="true">#</a> 2.3.4 编码操作</h4>
<ol>
<li>内部读取某个属性值</li>
</ol>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">this</span><span class="token punctuation">.</span>props<span class="token punctuation">.</span>xxx
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div><ol start="2">
<li>对props中的属性值进行类型限制和必要性限制
第一种方式（React v15.5 开始已弃用）：</li>
</ol>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>Person<span class="token punctuation">.</span>propTypes <span class="token operator">=</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br></div></div><p>第二种方式（新）：使用prop-types库进限制（需要引入prop-types库）</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>Person<span class="token punctuation">.</span>propTypes <span class="token operator">=</span> <span class="token punctuation">{</span>
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token operator">&lt;</span>Person <span class="token punctuation">{</span><span class="token operator">...</span>args<span class="token punctuation">}</span> <span class="token operator">/</span><span class="token operator">></span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div><ol start="4">
<li>默认属性值：</li>
</ol>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>Person<span class="token punctuation">.</span>defaultProps <span class="token operator">=</span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br></div></div><h3 id="_2-4-属性3-refs与事件处理" tabindex="-1"><a class="header-anchor" href="#_2-4-属性3-refs与事件处理" aria-hidden="true">#</a> 2.4 属性3: refs与事件处理</h3>
<h4 id="_2-4-1-效果" tabindex="-1"><a class="header-anchor" href="#_2-4-1-效果" aria-hidden="true">#</a> 2.4.1 效果</h4>
<p>需求: 自定义组件, 功能说明如下:</p>
<ol>
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">class</span> <span class="token class-name">Demo</span> <span class="token keyword">extends</span> <span class="token class-name">React<span class="token punctuation">.</span>Component</span> <span class="token punctuation">{</span>
  <span class="token function">render</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
    <span class="token keyword">return</span> <span class="token punctuation">(</span>
      <span class="token operator">&lt;</span>div<span class="token operator">></span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br></div></div><h4 id="_2-4-2-理解" tabindex="-1"><a class="header-anchor" href="#_2-4-2-理解" aria-hidden="true">#</a> 2.4.2 理解</h4>
<ul>
<li>组件内的标签可以定义ref属性来标识自己</li>
</ul>
<h4 id="_2-4-3-编码" tabindex="-1"><a class="header-anchor" href="#_2-4-3-编码" aria-hidden="true">#</a> 2.4.3 编码</h4>
<ol>
<li>字符串形式的ref【尽量不要使用，会有效率问题】</li>
</ol>
<div class="language-html ext-html line-numbers-mode"><pre v-pre class="language-html"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>input</span> <span class="token attr-name">ref</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>input1<span class="token punctuation">"</span></span> <span class="token punctuation">/></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div><ol start="2">
<li>回调形式的ref【以内联函数定义时，组件更新会被执行两次】</li>
</ol>
<div class="language-jsx ext-jsx line-numbers-mode"><pre v-pre class="language-jsx"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>input</span> <span class="token attr-name">ref</span><span class="token script language-javascript"><span class="token script-punctuation punctuation">=</span><span class="token punctuation">{</span><span class="token parameter">c</span> <span class="token operator">=></span> <span class="token keyword">this</span><span class="token punctuation">.</span>input1 <span class="token operator">=</span> c<span class="token punctuation">}</span></span> <span class="token punctuation">/></span></span>
...
<div class="language-jsx ext-jsx line-numbers-mode"><pre v-pre class="language-jsx"><code>myRef <span class="token operator">=</span> React<span class="token punctuation">.</span><span class="token function">createRef</span><span class="token punctuation">(</span><span class="token punctuation">)</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br></div></div><h4 id="_2-4-4-事件处理" tabindex="-1"><a class="header-anchor" href="#_2-4-4-事件处理" aria-hidden="true">#</a> 2.4.4 事件处理</h4>
<ol>
...
<h3 id="_2-5-收集表单数据" tabindex="-1"><a class="header-anchor" href="#_2-5-收集表单数据" aria-hidden="true">#</a> 2.5 收集表单数据</h3>
<h4 id="_2-5-1-效果" tabindex="-1"><a class="header-anchor" href="#_2-5-1-效果" aria-hidden="true">#</a> 2.5.1 效果</h4>
<p>需求:</p>
<ul>
<li>定义一个包含表单的组件</li>
<li>输入用户名密码后, 点击登录提示输入信息</li>
</ul>
<h4 id="_2-5-2-理解" tabindex="-1"><a class="header-anchor" href="#_2-5-2-理解" aria-hidden="true">#</a> 2.5.2 理解</h4>
<p>包含表单的组件分类：</p>
<ol>
<li>受控组件</li>
</ol>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">class</span> <span class="token class-name">Login</span> <span class="token keyword">extends</span> <span class="token class-name">React<span class="token punctuation">.</span>Component</span> <span class="token punctuation">{</span>
  state <span class="token operator">=</span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br></div></div><ol start="2">
<li>非受控组件</li>
</ol>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">class</span> <span class="token class-name">Login</span> <span class="token keyword">extends</span> <span class="token class-name">React<span class="token punctuation">.</span>Component</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
ReactDOM<span class="token punctuation">.</span><span class="token function">render</span><span class="token punctuation">(</span><span class="token operator">&lt;</span>Login <span class="token operator">/</span><span class="token operator">></span><span class="token punctuation">,</span> document<span class="token punctuation">.</span><span class="token function">getElementById</span><span class="token punctuation">(</span><span class="token string">'test1'</span><span class="token punctuation">)</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br></div></div><h3 id="_2-6-组件的生命周期" tabindex="-1"><a class="header-anchor" href="#_2-6-组件的生命周期" aria-hidden="true">#</a> 2.6 组件的生命周期</h3>
<h4 id="_2-6-1-效果" tabindex="-1"><a class="header-anchor" href="#_2-6-1-效果" aria-hidden="true">#</a> 2.6.1 效果</h4>
<p>需求:定义组件实现以下功能：</p>
<ol>
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token comment">//创建组件</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br></div></div><h4 id="_2-6-2-理解" tabindex="-1"><a class="header-anchor" href="#_2-6-2-理解" aria-hidden="true">#</a> 2.6.2 理解</h4>
<ol>
<li>组件从创建到死亡它会经历一些特定的阶段。</li>
<li>React组件中包含一系列勾子函数(生命周期回调函数), 会在特定的时刻调用。</li>
<li>我们在定义组件时，会在特定的生命周期回调函数中，做特定的工作。</li>
</ol>
<h4 id="_2-6-3-生命周期流程图-旧" tabindex="-1"><a class="header-anchor" href="#_2-6-3-生命周期流程图-旧" aria-hidden="true">#</a> 2.6.3 生命周期流程图(旧)</h4>
<p><img src="@source/.vuepress/public/images/1676897002197.jpg" alt="生命周期流程图旧"></p>
<p>生命周期的三个阶段（旧）</p>
<ul>
...
<li>render()</li>
<li><em><strong>componentDidMount()</strong></em></li>
</ol>
<ul>
<li><strong>更新阶段</strong>: 由组件内部this.setSate()或父组件重新render触发</li>
</ul>
<ol>
...
<ul>
<li><strong>卸载组件</strong>: 由ReactDOM.unmountComponentAtNode()触发</li>
</ul>
<ol>
<li><em><strong>componentWillUnmount()</strong></em></li>
</ol>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token comment">//创建组件</span>
...
<p><img src="@source/.vuepress/public/images/1676896952493.jpg" alt="生命周期流程图新"></p>
<p>生命周期的三个阶段（新）</p>
<ul>
<li><strong>初始化阶段</strong>: 由ReactDOM.render()触发---初次渲染</li>
</ul>
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br><span class="line-number">43</span><br><span class="line-number">44</span><br><span class="line-number">45</span><br><span class="line-number">46</span><br><span class="line-number">47</span><br><span class="line-number">48</span><br><span class="line-number">49</span><br><span class="line-number">50</span><br><span class="line-number">51</span><br><span class="line-number">52</span><br><span class="line-number">53</span><br><span class="line-number">54</span><br><span class="line-number">55</span><br><span class="line-number">56</span><br><span class="line-number">57</span><br><span class="line-number">58</span><br><span class="line-number">59</span><br><span class="line-number">60</span><br><span class="line-number">61</span><br><span class="line-number">62</span><br><span class="line-number">63</span><br><span class="line-number">64</span><br><span class="line-number">65</span><br><span class="line-number">66</span><br><span class="line-number">67</span><br><span class="line-number">68</span><br><span class="line-number">69</span><br><span class="line-number">70</span><br><span class="line-number">71</span><br><span class="line-number">72</span><br></div></div><h4 id="_2-6-5-重要的勾子" tabindex="-1"><a class="header-anchor" href="#_2-6-5-重要的勾子" aria-hidden="true">#</a> 2.6.5 重要的勾子</h4>
<ol>
<li><em><strong>render</strong></em>：初始化渲染或更新渲染调用</li>
<li><em><strong>componentDidMount</strong></em>：开启监听, 发送ajax请求</li>
<li><em><strong>componentWillUnmount</strong></em>：做一些收尾工作, 如: 清理定时器</li>
</ol>
<h4 id="_2-6-6-即将废弃的勾子" tabindex="-1"><a class="header-anchor" href="#_2-6-6-即将废弃的勾子" aria-hidden="true">#</a> 2.6.6 即将废弃的勾子</h4>
<ol>
<li>componentWillMount</li>
<li>componentWillReceiveProps</li>
<li>componentWillUpdate
现在使用会出现警告，下一个大版本需要加上UNSAFE_前缀才能使用，以后可能会被彻底废弃，不建议使用。</li>
</ol>
<h2 id="_3-react应用-react脚手架" tabindex="-1"><a class="header-anchor" href="#_3-react应用-react脚手架" aria-hidden="true">#</a> 3.React应用(React脚手架)</h2>
<h3 id="_3-1-创建react应用" tabindex="-1"><a class="header-anchor" href="#_3-1-创建react应用" aria-hidden="true">#</a> 3.1 创建react应用</h3>
<h4 id="_3-1-1-react脚手架" tabindex="-1"><a class="header-anchor" href="#_3-1-1-react脚手架" aria-hidden="true">#</a> 3.1.1 react脚手架</h4>
<ol>
<li>xxx脚手架: 用来帮助程序员快速创建一个基于xxx库的模板项目
<ol>
...
<li>react提供了一个用于创建react项目的脚手架库: <em><strong>create-react-app</strong></em></li>
<li>项目的整体技术架构为:  react + webpack + es6 + eslint</li>
<li>使用脚手架开发的项目的特点: 模块化, 组件化, 工程化</li>
</ol>
<h4 id="_3-1-2-创建项目并启动" tabindex="-1"><a class="header-anchor" href="#_3-1-2-创建项目并启动" aria-hidden="true">#</a> 3.1.2 创建项目并启动</h4>
<ul>
<li>第一步，全局安装：npm i -g create-react-app</li>
<li>第二步，切换到想创项目的目录，使用命令：create-react-app hello-react</li>
<li>第三步，进入项目文件夹：cd hello-react</li>
<li>第四步，启动项目：npm start</li>
</ul>
<h4 id="_3-1-3-react脚手架项目结构" tabindex="-1"><a class="header-anchor" href="#_3-1-3-react脚手架项目结构" aria-hidden="true">#</a> 3.1.3 react脚手架项目结构</h4>
<div class="language-ls ext-ls line-numbers-mode"><pre v-pre class="language-ls"><code>public ---- 静态资源文件夹
  favicon.icon ------ 网站页签图标
  index.html -------- 主页面
  logo192.png ------- logo图
  logo512.png ------- logo图
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br></div></div><h4 id="_3-1-4-功能界面的组件化编码流程-通用" tabindex="-1"><a class="header-anchor" href="#_3-1-4-功能界面的组件化编码流程-通用" aria-hidden="true">#</a> 3.1.4 功能界面的组件化编码流程（通用）</h4>
<ol>
<li><strong>拆分组件</strong>: 拆分界面，抽取组件</li>
<li><strong>实现静态组件</strong>: 使用组件实现静态页面效果</li>
<li><strong>实现动态组件</strong>:
<ul>
<li>3.1 动态显示初始化数据
<ul>
<li>3.1.1 数据类型</li>
...
<h3 id="_3-2-组件的组合使用-todolist" tabindex="-1"><a class="header-anchor" href="#_3-2-组件的组合使用-todolist" aria-hidden="true">#</a> 3.2 组件的组合使用-TodoList</h3>
<p>功能: 组件化实现此功能</p>
<ol>
<li>显示所有todo列表</li>
...
<ul>
<li>父传子props【字符串、布尔值、对象】</li>
<li>子传父props【函数】</li>
<li>uuid【安装：<code>yarn add nanoid</code>】【使用：<code>nanoid()</code>】</li>
<li><a href="https://gitee.com/ele-cat/react-basic/tree/master/react-staging/03.src_TodoList%E6%A1%88%E4%BE%8B" target="_blank" rel="noopener noreferrer">TodoList案例<ExternalLinkIcon/></a></li>
</ul>
<h2 id="_4-react-ajax" tabindex="-1"><a class="header-anchor" href="#_4-react-ajax" aria-hidden="true">#</a> 4.React ajax</h2>
<h3 id="_4-1-理解" tabindex="-1"><a class="header-anchor" href="#_4-1-理解" aria-hidden="true">#</a> 4.1 理解</h3>
<h4 id="_4-1-1-前置说明" tabindex="-1"><a class="header-anchor" href="#_4-1-1-前置说明" aria-hidden="true">#</a> 4.1.1 前置说明</h4>
<ol>
<li>React本身只关注于界面, 并不包含发送ajax请求的代码</li>
<li>前端应用需要通过ajax请求与后台进行交互(json数据)</li>
<li>react应用中需要集成第三方ajax库(或自己封装)</li>
</ol>
<h4 id="_4-1-2-常用的ajax请求库" tabindex="-1"><a class="header-anchor" href="#_4-1-2-常用的ajax请求库" aria-hidden="true">#</a> 4.1.2 常用的ajax请求库</h4>
<ol>
...
<h3 id="_4-2-react脚手架配置代理" tabindex="-1"><a class="header-anchor" href="#_4-2-react脚手架配置代理" aria-hidden="true">#</a> 4.2 react脚手架配置代理</h3>
<h4 id="方法一" tabindex="-1"><a class="header-anchor" href="#方法一" aria-hidden="true">#</a> 方法一</h4>
<blockquote>
<p>在package.json中追加如下配置</p>
</blockquote>
<div class="language-json ext-json line-numbers-mode"><pre v-pre class="language-json"><code><span class="token property">"proxy"</span><span class="token operator">:</span> <span class="token string">"http://localhost:5000"</span>
...
<h4 id="方法二" tabindex="-1"><a class="header-anchor" href="#方法二" aria-hidden="true">#</a> 方法二</h4>
<ol>
<li>第一步：创建代理配置文件，在src下创建配置文件：<code>src/setupProxy.js</code></li>
...
<ol>
<li>低版本的http-proxy-middleware在配置代理时，不需要加<code>createProxyMiddleware</code>，高版本必须加<code>createProxyMiddleware</code></li>
</ol>
<h3 id="_4-3-axios" tabindex="-1"><a class="header-anchor" href="#_4-3-axios" aria-hidden="true">#</a> 4.3 axios</h3>
<h4 id="_4-3-1-文档" tabindex="-1"><a class="header-anchor" href="#_4-3-1-文档" aria-hidden="true">#</a> 4.3.1 文档</h4>
<p><a href="http://axios-js.com/" target="_blank" rel="noopener noreferrer">axios官方文档<ExternalLinkIcon/></a></p>
<h4 id="_4-3-2-相关api" tabindex="-1"><a class="header-anchor" href="#_4-3-2-相关api" aria-hidden="true">#</a> 4.3.2 相关API</h4>
<ol>
<li>GET请求</li>
</ol>
...
console<span class="token punctuation">.</span><span class="token function">log</span><span class="token punctuation">(</span>error<span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br></div></div><h3 id="_4-4-案例—github用户搜索" tabindex="-1"><a class="header-anchor" href="#_4-4-案例—github用户搜索" aria-hidden="true">#</a> 4.4 案例—github用户搜索</h3>
<ul>
<li><a href="https://api.github.com/search/users?q=xxxxxx" target="_blank" rel="noopener noreferrer">请求地址<ExternalLinkIcon/></a></li>
<li><a href="https://gitee.com/ele-cat/react-basic/tree/master/react-staging/05.src_axios%E6%A1%88%E4%BE%8Bgithub%E6%90%9C%E7%B4%A2" target="_blank" rel="noopener noreferrer">案例地址<ExternalLinkIcon/></a></li>
</ul>
<h3 id="_4-5-消息订阅-发布机制" tabindex="-1"><a class="header-anchor" href="#_4-5-消息订阅-发布机制" aria-hidden="true">#</a> 4.5 消息订阅-发布机制</h3>
<ol>
<li>工具库: <a href="https://github.com/mroderick/PubSubJS" target="_blank" rel="noopener noreferrer">PubSubJS<ExternalLinkIcon/></a></li>
...
<li>const token = PubSub.subscribe('delete', function(_, data){ }); //订阅</li>
<li>PubSub.publish('delete', data) //发布消息</li>
<li>PubSub.unsubscribe(token) //移除</li>
</ul>
</blockquote>
<ul>
<li><a href="https://gitee.com/ele-cat/react-basic/tree/master/react-staging/06.src_pubsub%E6%A1%88%E4%BE%8Bgithub%E6%90%9C%E7%B4%A2" target="_blank" rel="noopener noreferrer">案例地址<ExternalLinkIcon/></a></li>
</ul>
<h3 id="_4-6-扩展-fetch" tabindex="-1"><a class="header-anchor" href="#_4-6-扩展-fetch" aria-hidden="true">#</a> 4.6 扩展：Fetch</h3>
<h4 id="_4-6-1-文档" tabindex="-1"><a class="header-anchor" href="#_4-6-1-文档" aria-hidden="true">#</a> 4.6.1 文档</h4>
<ol>
<li><a href="https://github.github.io/fetch/" target="_blank" rel="noopener noreferrer">官方文档<ExternalLinkIcon/></a></li>
<li><a href="https://segmentfault.com/a/1190000003810652" target="_blank" rel="noopener noreferrer">思否文档<ExternalLinkIcon/></a></li>
<li><a href="https://gitee.com/ele-cat/react-basic/tree/master/react-staging/07.src_fetch%E6%A1%88%E4%BE%8Bgithub%E6%90%9C%E7%B4%A2" target="_blank" rel="noopener noreferrer">案例地址<ExternalLinkIcon/></a></li>
</ol>
<h4 id="_4-6-2-特点" tabindex="-1"><a class="header-anchor" href="#_4-6-2-特点" aria-hidden="true">#</a> 4.6.2 特点</h4>
<ol>
<li>fetch: 原生函数，不再使用XmlHttpRequest对象提交ajax请求</li>
<li>老版本浏览器可能不支持</li>
</ol>
<h4 id="_4-6-3-相关api" tabindex="-1"><a class="header-anchor" href="#_4-6-3-相关api" aria-hidden="true">#</a> 4.6.3 相关API</h4>
<ol>
<li>GET请求</li>
</ol>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token function">fetch</span><span class="token punctuation">(</span>url<span class="token punctuation">)</span><span class="token punctuation">.</span><span class="token function">then</span><span class="token punctuation">(</span><span class="token keyword">function</span><span class="token punctuation">(</span><span class="token parameter">response</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">.</span><span class="token function">catch</span><span class="token punctuation">(</span><span class="token keyword">function</span><span class="token punctuation">(</span><span class="token parameter">e</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  console<span class="token punctuation">.</span><span class="token function">log</span><span class="token punctuation">(</span>e<span class="token punctuation">)</span>
<span class="token punctuation">}</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br></div></div><h2 id="_5-react路由" tabindex="-1"><a class="header-anchor" href="#_5-react路由" aria-hidden="true">#</a> 5.React路由</h2>
<h3 id="_5-1-相关理解" tabindex="-1"><a class="header-anchor" href="#_5-1-相关理解" aria-hidden="true">#</a> 5.1 相关理解</h3>
<h4 id="_5-1-1-spa的理解" tabindex="-1"><a class="header-anchor" href="#_5-1-1-spa的理解" aria-hidden="true">#</a> 5.1.1 SPA的理解</h4>
<ol>
...
<h4 id="_5-1-2-路由的理解" tabindex="-1"><a class="header-anchor" href="#_5-1-2-路由的理解" aria-hidden="true">#</a> 5.1.2 路由的理解</h4>
<ol>
<li>什么是路由?
<ol>
...
<h4 id="_5-1-3-react-router-dom的理解" tabindex="-1"><a class="header-anchor" href="#_5-1-3-react-router-dom的理解" aria-hidden="true">#</a> 5.1.3 react-router-dom的理解</h4>
<ol>
<li>react的一个插件库。</li>
<li>专门用来实现一个SPA应用。</li>
<li>基于react的项目基本都会用到此库。</li>
</ol>
<h3 id="_5-2-react-router-dom相关api" tabindex="-1"><a class="header-anchor" href="#_5-2-react-router-dom相关api" aria-hidden="true">#</a> 5.2 react-router-dom相关API</h3>
<h4 id="_5-2-1-内置组件" tabindex="-1"><a class="header-anchor" href="#_5-2-1-内置组件" aria-hidden="true">#</a> 5.2.1 内置组件</h4>
<ol>
<li><code>&lt;BrowserRouter&gt;</code> history模式的包裹</li>
<li><code>&lt;HashRouter&gt;</code>    hash模式的包裹</li>
<li><code>&lt;Route&gt;</code>         注册路由组件</li>
<li><code>&lt;Redirect&gt;</code>      重定向组件</li>
<li><code>&lt;Link&gt;</code>          跳转组件</li>
<li><code>&lt;NavLink&gt;</code>       跳转组件-高亮匹配</li>
<li><code>&lt;Switch&gt;</code>        路由匹配到即停止</li>
</ol>
<h4 id="_5-2-2-其它" tabindex="-1"><a class="header-anchor" href="#_5-2-2-其它" aria-hidden="true">#</a> 5.2.2 其它</h4>
<ol>
<li>history对象</li>
<li>match对象</li>
<li>withRouter函数</li>
</ol>
<h3 id="_5-3-路由的使用" tabindex="-1"><a class="header-anchor" href="#_5-3-路由的使用" aria-hidden="true">#</a> 5.3 路由的使用</h3>
<h4 id="_5-3-1-路由的基本使用" tabindex="-1"><a class="header-anchor" href="#_5-3-1-路由的基本使用" aria-hidden="true">#</a> 5.3.1 路由的基本使用</h4>
<ol>
<li>明确好界面中的组件构造</li>
<li>导航区的a标签改为<code>&lt;Link to=&quot;&quot;&gt;&lt;/Link&gt;</code>标签</li>
<li>内容区的展示组件改为<code>&lt;Route path=&quot;&quot; component={} /&gt;</code>标签</li>
<li>在<code>&lt;App /&gt;</code>标签外包裹<code>&lt;BrowserRouter&gt;</code>或<code>&lt;HashRouter&gt;</code></li>
</ol>
<ul>
<li><a href="https://gitee.com/ele-cat/react-basic/tree/master/react-staging/08.src_%E8%B7%AF%E7%94%B1%E7%9A%84%E5%9F%BA%E6%9C%AC%E4%BD%BF%E7%94%A8" target="_blank" rel="noopener noreferrer">案例地址<ExternalLinkIcon/></a></li>
</ul>
<h4 id="_5-3-2-路由组件与一般组件的差异" tabindex="-1"><a class="header-anchor" href="#_5-3-2-路由组件与一般组件的差异" aria-hidden="true">#</a> 5.3.2 路由组件与一般组件的差异</h4>
<ol>
<li>写法不同：
<ul>
...
<li>存放位置不同：
<ul>
<li>一般组件：component</li>
<li>路由组件：pages</li>
</ul>
</li>
<li>接收到的props不同
<ul>
<li>一般组件：父组件传递进来的数据</li>
<li>路由组件：接收路由传递的属性</li>
</ul>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>    <span class="token literal-property property">history</span><span class="token operator">:</span>
...
<h4 id="_5-3-3-navlink的使用" tabindex="-1"><a class="header-anchor" href="#_5-3-3-navlink的使用" aria-hidden="true">#</a> 5.3.3 NavLink的使用</h4>
<blockquote>
<p>使用场景：当需要给路由添加高亮时</p>
</blockquote>
<div class="language-html ext-html line-numbers-mode"><pre v-pre class="language-html"><code>就可以把
...
<li>当切换到对应的路由时，会给对应的a标签添加<code>active</code>类</li>
<li>可通过修改<code>activeClassName</code>，来修改高亮<code>className</code></li>
<li>示例：</li>
</ol>
<div class="language-html ext-html line-numbers-mode"><pre v-pre class="language-html"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>NavLink</span> <span class="token attr-name">activeClassName</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">'</span>ecat<span class="token punctuation">'</span></span> <span class="token attr-name">className</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>list-group-item<span class="token punctuation">"</span></span> <span class="token attr-name">to</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>/about<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>About<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>NavLink</span><span class="token punctuation">></span></span>
简写：
...
<li><a href="https://gitee.com/ele-cat/react-basic/tree/master/react-staging/09.src_NavLink%E7%9A%84%E4%BD%BF%E7%94%A8" target="_blank" rel="noopener noreferrer">案例地址<ExternalLinkIcon/></a></li>
</ol>
<blockquote>
<p>可通过<code>this.props.children</code>来获取组件标签体内容</p>
</blockquote>
<ul>
<li><a href="https://gitee.com/ele-cat/react-basic/tree/master/react-staging/10.src_NavLink%E5%B0%81%E8%A3%85" target="_blank" rel="noopener noreferrer">封装NavLink案例地址<ExternalLinkIcon/></a></li>
</ul>
<h4 id="_5-3-4-switch使用" tabindex="-1"><a class="header-anchor" href="#_5-3-4-switch使用" aria-hidden="true">#</a> 5.3.4 Switch使用</h4>
<ol>
<li>通常情况下，<code>Route</code>的 path 和 component 是一一对应的关系。</li>
<li><code>Switch</code>可以提高路由的匹配效率【匹配到即停止】。</li>
</ol>
<div class="language-html ext-html line-numbers-mode"><pre v-pre class="language-html"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>Switch</span><span class="token punctuation">></span></span>
...
<li><a href="https://gitee.com/ele-cat/react-basic/tree/master/react-staging/11.Switch%E7%9A%84%E4%BD%BF%E7%94%A8" target="_blank" rel="noopener noreferrer">案例地址<ExternalLinkIcon/></a></li>
</ul>
<h4 id="_5-3-5-样式缺失修复" tabindex="-1"><a class="header-anchor" href="#_5-3-5-样式缺失修复" aria-hidden="true">#</a> 5.3.5 样式缺失修复</h4>
<ol>
<li>public目录下的<code>index.html</code>中引用文件使用绝对路径</li>
</ol>
<div class="language-html ext-html line-numbers-mode"><pre v-pre class="language-html"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>link</span> <span class="token attr-name">rel</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>stylesheet<span class="token punctuation">"</span></span> <span class="token attr-name">href</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>/css/bootstrap.css<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div><ol start="2">
<li>public目录下的<code>index.html</code>中引用文件使用<code>%PUBLIC_URL%</code></li>
</ol>
<div class="language-html ext-html line-numbers-mode"><pre v-pre class="language-html"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>link</span> <span class="token attr-name">rel</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>stylesheet<span class="token punctuation">"</span></span> <span class="token attr-name">href</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>%PUBLIC_URL%/css/bootstrap.css<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div><ol start="3">
<li>根<code>&lt;App /&gt;</code>组件使用<code>&lt;HashRouter&gt;</code>包裹</li>
</ol>
<div class="language-jsx ext-jsx line-numbers-mode"><pre v-pre class="language-jsx"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span><span class="token class-name">HashRouter</span></span><span class="token punctuation">></span></span><span class="token plain-text">
...
<li><a href="https://gitee.com/ele-cat/react-basic/tree/master/react-staging/12.src_%E6%A0%B7%E5%BC%8F%E7%BC%BA%E5%A4%B1%E4%BF%AE%E5%A4%8D" target="_blank" rel="noopener noreferrer">案例地址<ExternalLinkIcon/></a></li>
</ul>
<h4 id="_5-3-6-路由的严格匹配和模糊匹配" tabindex="-1"><a class="header-anchor" href="#_5-3-6-路由的严格匹配和模糊匹配" aria-hidden="true">#</a> 5.3.6 路由的严格匹配和模糊匹配</h4>
<ol>
<li>默认使用的是模糊匹配，【输入的路径】必须要包含【匹配的路径】，且<strong>顺序一致</strong></li>
<li>开启严格模式<code>&lt;Route exact path=&quot;&quot; component={} /&gt;</code></li>
<li>严格模式不要随意开启，需要再打开，否则会导致无法匹配二级路由</li>
</ol>
<ul>
<li><a href="https://gitee.com/ele-cat/react-basic/tree/master/react-staging/13.src_%E7%B2%BE%E5%87%86%E5%8C%B9%E9%85%8D%E4%B8%8E%E6%A8%A1%E7%B3%8A%E5%8C%B9%E9%85%8D" target="_blank" rel="noopener noreferrer">案例地址<ExternalLinkIcon/></a></li>
</ul>
<h4 id="_5-3-7-redirect使用" tabindex="-1"><a class="header-anchor" href="#_5-3-7-redirect使用" aria-hidden="true">#</a> 5.3.7 Redirect使用</h4>
<ol>
...
<li><a href="https://gitee.com/ele-cat/react-basic/tree/master/react-staging/14.src_Redirect%E4%BD%BF%E7%94%A8" target="_blank" rel="noopener noreferrer">案例地址<ExternalLinkIcon/></a></li>
</ul>
<h4 id="_5-3-8-嵌套路由" tabindex="-1"><a class="header-anchor" href="#_5-3-8-嵌套路由" aria-hidden="true">#</a> 5.3.8 嵌套路由</h4>
<ol>
<li>注册子路由时要写上父路由的path值</li>
<li>路由的匹配是按照路由注册的顺序进行的</li>
</ol>
<ul>
<li><a href="https://gitee.com/ele-cat/react-basic/tree/master/react-staging/15.src_%E5%B5%8C%E5%A5%97%E8%B7%AF%E7%94%B1" target="_blank" rel="noopener noreferrer">案例地址<ExternalLinkIcon/></a></li>
</ul>
<h3 id="_5-4-路由传参" tabindex="-1"><a class="header-anchor" href="#_5-4-路由传参" aria-hidden="true">#</a> 5.4 路由传参</h3>
<h4 id="_5-4-1-params传参" tabindex="-1"><a class="header-anchor" href="#_5-4-1-params传参" aria-hidden="true">#</a> 5.4.1 params传参</h4>
<ol>
<li>路由链接（携带参数）</li>
</ol>
...
<div class="language-jsx ext-jsx line-numbers-mode"><pre v-pre class="language-jsx"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span><span class="token class-name">Route</span></span> <span class="token attr-name">path</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>/home/news/detail/:id<span class="token punctuation">"</span></span> <span class="token attr-name">component</span><span class="token script language-javascript"><span class="token script-punctuation punctuation">=</span><span class="token punctuation">{</span>Detail<span class="token punctuation">}</span></span> <span class="token punctuation">/></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div><ol start="3">
<li>组件接参</li>
</ol>
<div class="language-jsx ext-jsx line-numbers-mode"><pre v-pre class="language-jsx"><code><span class="token keyword">const</span> <span class="token punctuation">{</span>id<span class="token punctuation">}</span> <span class="token operator">=</span> <span class="token keyword">this</span><span class="token punctuation">.</span>props<span class="token punctuation">.</span>match<span class="token punctuation">.</span>params
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div><ul>
<li><a href="https://gitee.com/ele-cat/react-basic/tree/master/react-staging/16.src_%E4%BC%A0%E5%8F%82params" target="_blank" rel="noopener noreferrer">案例地址<ExternalLinkIcon/></a></li>
</ul>
<h4 id="_5-4-2-search参数" tabindex="-1"><a class="header-anchor" href="#_5-4-2-search参数" aria-hidden="true">#</a> 5.4.2 search参数</h4>
<ol>
<li>路由链接（携带参数）</li>
</ol>
...
<div class="language-jsx ext-jsx line-numbers-mode"><pre v-pre class="language-jsx"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span><span class="token class-name">Route</span></span> <span class="token attr-name">path</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>/home/news/detail<span class="token punctuation">"</span></span> <span class="token attr-name">component</span><span class="token script language-javascript"><span class="token script-punctuation punctuation">=</span><span class="token punctuation">{</span>Detail<span class="token punctuation">}</span></span> <span class="token punctuation">/></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div><ol start="3">
<li>组件接参</li>
</ol>
<div class="language-jsx ext-jsx line-numbers-mode"><pre v-pre class="language-jsx"><code><span class="token keyword">import</span> qs <span class="token keyword">from</span> <span class="token string">'querystringify'</span>
...
<li><a href="https://gitee.com/ele-cat/react-basic/tree/master/react-staging/18.src_%E4%BC%A0%E5%8F%82state" target="_blank" rel="noopener noreferrer">案例地址<ExternalLinkIcon/></a></li>
</ul>
<h3 id="_5-5-路由跳转模式" tabindex="-1"><a class="header-anchor" href="#_5-5-路由跳转模式" aria-hidden="true">#</a> 5.5 路由跳转模式</h3>
<ol>
<li>push</li>
</ol>
<div class="language-jsx ext-jsx line-numbers-mode"><pre v-pre class="language-jsx"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span><span class="token class-name">Link</span></span> <span class="token attr-name">to</span><span class="token script language-javascript"><span class="token script-punctuation punctuation">=</span><span class="token punctuation">{</span><span class="token punctuation">{</span><span class="token literal-property property">pathname</span><span class="token operator">:</span> <span class="token string">'/home/news/detail'</span><span class="token punctuation">,</span> <span class="token literal-property property">state</span><span class="token operator">:</span> <span class="token punctuation">{</span><span class="token literal-property property">id</span><span class="token operator">:</span> item<span class="token punctuation">.</span>id<span class="token punctuation">}</span><span class="token punctuation">}</span><span class="token punctuation">}</span></span><span class="token punctuation">></span></span><span class="token plain-text">新闻1</span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span><span class="token class-name">Link</span></span><span class="token punctuation">></span></span>
...
<div class="language-jsx ext-jsx line-numbers-mode"><pre v-pre class="language-jsx"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span><span class="token class-name">Link</span></span> <span class="token attr-name">replace</span> <span class="token attr-name">to</span><span class="token script language-javascript"><span class="token script-punctuation punctuation">=</span><span class="token punctuation">{</span><span class="token punctuation">{</span><span class="token literal-property property">pathname</span><span class="token operator">:</span> <span class="token string">'/home/news/detail'</span><span class="token punctuation">,</span> <span class="token literal-property property">state</span><span class="token operator">:</span> <span class="token punctuation">{</span><span class="token literal-property property">id</span><span class="token operator">:</span> item<span class="token punctuation">.</span>id<span class="token punctuation">}</span><span class="token punctuation">}</span><span class="token punctuation">}</span></span><span class="token punctuation">></span></span><span class="token plain-text">新闻1</span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span><span class="token class-name">Link</span></span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div><ul>
<li><a href="https://gitee.com/ele-cat/react-basic/tree/master/react-staging/19.src_push&amp;replace" target="_blank" rel="noopener noreferrer">案例地址<ExternalLinkIcon/></a></li>
</ul>
<h3 id="_5-6-编程式路由" tabindex="-1"><a class="header-anchor" href="#_5-6-编程式路由" aria-hidden="true">#</a> 5.6 编程式路由</h3>
<blockquote>
<p>借助<code>this.props.history</code>对象上的API对路由进行跳转、前进、后退操作</p>
</blockquote>
<div class="language-jsx ext-jsx line-numbers-mode"><pre v-pre class="language-jsx"><code><span class="token keyword">this</span><span class="token punctuation">.</span>props<span class="token punctuation">.</span>history<span class="token punctuation">.</span><span class="token function">push</span><span class="token punctuation">(</span><span class="token punctuation">)</span>      <span class="token comment">// 跳转</span>
...
<li><a href="https://gitee.com/ele-cat/react-basic/tree/master/react-staging/20.src_%E7%BC%96%E7%A8%8B%E5%BC%8F%E8%B7%AF%E7%94%B1" target="_blank" rel="noopener noreferrer">案例地址<ExternalLinkIcon/></a></li>
</ul>
<h3 id="_5-7-withrouter" tabindex="-1"><a class="header-anchor" href="#_5-7-withrouter" aria-hidden="true">#</a> 5.7 withRouter</h3>
<blockquote>
<p>一般组件的<code>props</code>中没有路由组件所持有的history API</p>
</blockquote>
<ul>
<li>需要使用<code>withRouter</code></li>
<li>withRouter可以加工一般组件，让一般组件可以具备路由组件所特有的API</li>
<li>withRouter返回的是一个新组件</li>
<li>示例：</li>
</ul>
...
<li><a href="https://gitee.com/ele-cat/react-basic/tree/master/react-staging/21.src_withRouter" target="_blank" rel="noopener noreferrer">案例地址<ExternalLinkIcon/></a></li>
</ul>
<h3 id="_5-8-browserrouter与hashrouter的区别" tabindex="-1"><a class="header-anchor" href="#_5-8-browserrouter与hashrouter的区别" aria-hidden="true">#</a> 5.8 BrowserRouter与HashRouter的区别</h3>
<ol>
<li>底层原理不一样：
<ol>
<li>BrowserRouter使用的是H5的history API，不兼容IE9及以下版本。</li>
<li>HashRouter使用的是URL的哈希值。</li>
</ol>
</li>
<li>path表现形式不一样
<ol>
<li>BrowserRouter的路径中没有#,例如：localhost:3000/demo/test</li>
<li>HashRouter的路径包含#,例如：localhost:3000/#/demo/test</li>
</ol>
</li>
<li>刷新后对路由state参数的影响
<ol>
...
<h2 id="_6-开源react-ui组件库" tabindex="-1"><a class="header-anchor" href="#_6-开源react-ui组件库" aria-hidden="true">#</a> 6.开源React UI组件库</h2>
<h3 id="_6-1-1-material-ui-国外" tabindex="-1"><a class="header-anchor" href="#_6-1-1-material-ui-国外" aria-hidden="true">#</a> 6.1.1 material-ui(国外)</h3>
<ol>
<li><a href="http://www.material-ui.com/#/" target="_blank" rel="noopener noreferrer">官网地址<ExternalLinkIcon/></a></li>
<li><a href="https://github.com/callemall/material-ui" target="_blank" rel="noopener noreferrer">github地址<ExternalLinkIcon/></a></li>
</ol>
<h3 id="_6-1-2-ant-design-国内蚂蚁金服" tabindex="-1"><a class="header-anchor" href="#_6-1-2-ant-design-国内蚂蚁金服" aria-hidden="true">#</a> 6.1.2 ant-design(国内蚂蚁金服)</h3>
<ol>
<li><a href="https://ant-design.gitee.io/index-cn" target="_blank" rel="noopener noreferrer">官网地址<ExternalLinkIcon/></a></li>
<li><a href="https://github.com/ant-design/ant-design/" target="_blank" rel="noopener noreferrer">github地址<ExternalLinkIcon/></a></li>
<li>安装依赖</li>
</ol>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token function">yarn</span> <span class="token function">add</span> antd
