...
```
- 执行`nodemon testError`，访问[http://localhost:8000/err](http://localhost:8000/err)报错无法重启
- 执行`pm2 start testError`，访问[http://localhost:8000/err](http://localhost:8000/err)报错后可以自动重启
#### 5.1.4 常用配置和日志记录
