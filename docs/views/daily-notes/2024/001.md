...
(function () {
  ...
  GM_addStyle(
    `#svg-button {width: 36px;fill: #fff;}.banner-add_container__aadfy, .chat_chat-input-actions__mwYC_, .home_sidebar-reward__VFUk8{display: none !important;}.home_sidebar__fPZfq{width: 230px}.home_window-content__2WGYf{flex: 1;}`
  );
