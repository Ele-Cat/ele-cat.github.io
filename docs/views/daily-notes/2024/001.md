...
4. 由于 B 站添加了 DOM 渲染校验机制，如果我们在校验前对 DOM 进行添加处理，会触发刷新页面或报错等，所以添加了`getElementObject`方法，来延迟获取 Video 是否加载成功；
5. 如果加载成功，则在`.video-toolbar-left-main`中添加“一键三连”的按钮并赋给它点击事件，同时，监听键盘点击“A”，也可以触发“一键三连”；
6. 访问并[直接安装](https://greasyfork.org/zh-CN/scripts/493083-ele-cat-bilibili%E4%B8%80%E9%94%AE%E4%B8%89%E8%BF%9E)。
