...
2. 跳转至“新建用户脚本”页面，如下图：
   ...
   红框所包围的代码头，为脚本的元数据，包括脚本名称、作者、描述等信息。可对照上图下文查看释义：
...
3. 利用已有前端知识，实现“百度两下”功能
   ...
   (function () {
     ...
     let btn = document.getElementsByClassName("btn self-btn bg s_btn")[0];
     btn.value = "百度两下";
   })();
   ```

   这样，打开[百度](https://www.baidu.com)，“百度一下”就显示为“百度两下”，如下图：
