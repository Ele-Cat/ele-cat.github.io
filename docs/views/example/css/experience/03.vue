...
const panding = (e) => {
  if (e.path[0].nodeName == 'DIV') return
  copyFn(e.path[0].innerHTML)
}
const copyFn = (val) => {
...
.main > span:hover {
  ...
  box-shadow: -2px -2px 6px 2px rgba(108, 108, 108, 0.1) inset,
    0 0 0 5px rgba(255, 255, 255, 0.6) inset, 0 0 0 1px rgba(139, 139, 139, 0.1),
